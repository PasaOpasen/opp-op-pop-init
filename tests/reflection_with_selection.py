...
plot_pop(points,  
                 ...
                 save_as = 'reflection_with_selection_before.png')
                 
                 
                 
better_points, better_vals = OppositionOperators.ReflectWithSelectionBest(points, 
...
plot_pop(better_points,  
                 ...
                 save_as = 'reflection_with_selection_after.png')
